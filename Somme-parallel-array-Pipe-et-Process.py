...
if __name__ == "__main__" :
    ...
    moitie1=pour_pere_to_read.recv() # Blocks until there is something to receive.
...
"""
TRACE :
[alex@begonia:~/CPE-ALL/CPE-Concurrent/CPE-Concurrent-Python-20-21/CPE-Concurrent-Python-Parallele-Avril-2021/Mon-Cours-Code-des-ex-du-cours-Python-Concurrent-20-21/Code-des-exemples-du-cours-1] python3 Somme-parallel-array-Pipe-et-Process-mieux.py
...
La somme totale du tableau oobtenue :  499999500000
